...
```
Themes: mono, fire, ocean, synthwave, viridis, pastel, matrix-green, rainbow. Verified by `python tests\verify_fx.py` — **36/36 pass** (28 effects + 8 fixed checks; is_animated routing mirrors the CLI).

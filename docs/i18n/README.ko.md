...
`@register` 데코레이터 + 자동 발견으로 구성됩니다. **22개 이펙트**(donut, solarsystem, fire, plasma, rain,
starfield, tunnel, text3d, cube, sphere, boids, life, fireworks, sparkle, decrypt,
gradient_text, banner_scroll, image2ascii, typewriter, julia, mandelbrot, perlin)를 **8개 테마**(mono, fire,
